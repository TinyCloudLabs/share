...
const evidence = {
  ...
  cleanup: { ownedProcessesStoppedBy: "test/e2e-email/integration.mjs", processScan: command("sh", ["-c", "ps -Ao pid=,ppid=,comm=,command= | awk '$3 == \"tinycloud-node-n4-mounted-fixture\" || $3 == \"email-claim-fixture\" || ($3 == \"postgres\" && index($0, \"tinycloud-email-claim-\") > 0) { print }'"], root) || "none", secretsIncluded: false },
};
